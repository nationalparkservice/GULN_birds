...
pkgs <- c("tidyverse", "here", "magrittr", "lubridate", "gridExtra", "grid", "ggforce", "scales", "plotly", "knitr", "DT", "crosstalk", "reactable", "htmltools", "sparkline")
...
# df_species <- readRDS(here::here("Data_out", "df_species.RDS")) # cleaned point count data
...
```{r}
# Table of number of points surveyed per park and yr_visit
...
## Point Count Detections by Species
...
Black cells mean no survey event.
...
plot_ly(
  ...
  layout(title = list(text=unique(shared_full_obs$species_code), y = 1.05, x = 0.5, xanchor = 'center', yanchor =  'top'), plot_bgcolor = "black")
